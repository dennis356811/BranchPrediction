...
class Top(prog_filename: String) extends Module {
    ...
    val branched_or_not         = Wire(Bool())
    val out_Reg_D_branch_or_not = Wire(Bool())
    val D_branched_or_not       = Wire(Bool())
    ...
    branched_or_not               := static_jump.io.branch_or_not
    ...
    reg_d.io.branch_or_not      := branched_or_not
    out_Reg_D_pc                := reg_d.io.out_Reg_D_pc
    inst_out_Reg_D              := reg_d.io.out_Reg_D_inst
    out_Reg_D_branch_or_not     := reg_d.io.out_Reg_D_branch_or_not
    ...
    reg_e.io.branch_or_not      := out_Reg_D_branch_or_not
    ...
    D_branched_or_not           := reg_e.io.out_Reg_E_branch_or_not
    ...
    jb_unit.io.D_branched_or_not:= D_branched_or_not
    ...
    controller.io.D_branched_or_not := D_branched_or_not 
